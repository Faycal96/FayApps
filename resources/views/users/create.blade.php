...
<!-- Début du champ de sélection des rôles -->
<div class="form-group row">
    <label for="roles" class="col-md-4 col-form-label text-md-end text-start">Rôles</label>
    <div class="col-md-6">           
        <select class="form-select @error('roles') is-invalid @enderror" multiple aria-label="Rôles" id="roles" name="roles[]">
            @forelse ($roles as $role)
                ...
                @endif 
            @empty
                <option value="">Pas de rôles disponibles</option>
            @endforelse
        </select>
        @error('roles')
...
<!-- Fin du champ de sélection des rôles -->

<!-- Continuation du formulaire en dessous... -->
